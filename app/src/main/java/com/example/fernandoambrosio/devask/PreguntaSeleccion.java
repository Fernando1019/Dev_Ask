...
public class PreguntaSeleccion  extends AppCompatActivity {
    ...
    public  void jugar() {
        ...
        if (numero == 1) {
            ...
            Intent intent = new Intent(PreguntaSeleccion.this, PreguntaFv.class);
        ...
        if (numero == 2) {
            ...
            Intent intent = new Intent(PreguntaSeleccion.this, PreguntaDirecta.class);
        ...
        if (numero == 3) {
            ...
            Intent intent = new Intent(PreguntaSeleccion.this, PreguntaSeleccion.class);
