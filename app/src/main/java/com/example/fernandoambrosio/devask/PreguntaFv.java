...
public class PreguntaFv extends AppCompatActivity {
    ...
    public  void jugar() {
        ...
        if (numero == 1) {
            ...
            Intent intent = new Intent(PreguntaFv.this, PreguntaFv.class);
        ...
        if (numero == 2) {
            ...
            Intent intent = new Intent(PreguntaFv.this, PreguntaDirecta.class);
        ...
        if (numero == 3) {
            ...
            Intent intent = new Intent(PreguntaFv.this, PreguntaSeleccion.class);
