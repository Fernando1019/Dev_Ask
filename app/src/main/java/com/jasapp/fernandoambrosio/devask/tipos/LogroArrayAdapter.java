 ...
 */
public class LogroArrayAdapter<T> extends ArrayAdapter<T> {
    public LogroArrayAdapter(Context context, List<T> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        TextView jugador = (TextView)listItemView.findViewById(android.R.id.text1);
